...
export default function TemplateCard({ template }: { template: Template }) {
  ...
  return (
    <article>
      <a
        href={`/details/${id}`}
        className="flex justify-between gap-8 max-md:flex-col md:h-44"
      >
        ...
        <div className="flex w-fit gap-4 overflow-x-auto [scrollbar-color:#888_transparent;] [scrollbar-width:thin]">
          <Image
            src={one}
            alt="Screenshot one"
            width={1607}
